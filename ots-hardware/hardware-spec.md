...
- **Protocol**: WebSocket server (same protocol as defined in `protocol-context.md`)
- **Port**: TBD (e.g., 8080)
...
The hardware uses the same protocol defined in `/protocol-context.md` at the WebSocket layer:
