...
This folder provides the **TypeScript implementation** of types defined in `/prompts/WEBSOCKET_MESSAGE_SPEC.md`. It serves as the single source of truth for TypeScript projects to prevent type duplication.
...
1. **Update source of truth**: `/prompts/WEBSOCKET_MESSAGE_SPEC.md` (root)
